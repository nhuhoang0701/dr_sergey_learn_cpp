...
`std::span` is a lightweight, non-owning view over a contiguous sequence of objects. It replaces the C-style `(T* data, size_t n)` parameter pattern with a safe, rich interface.
