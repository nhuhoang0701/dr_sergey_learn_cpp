...
**Semantic Versioning (SemVer)** defines what version number changes mean for users. **ABI versioning** ensures binary compatibility so existing programs don't break when libraries are updated.
...
**How inline namespaces solve ABI versioning:**
