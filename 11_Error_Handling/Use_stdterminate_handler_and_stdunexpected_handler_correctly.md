...
├────────────────────────────────────────────────────────┤
│ ✅ Log exception info via current_exception()          │
│ ✅ Write to log file (pre-opened if possible)          │
│ ✅ Call std::abort() or std::_Exit()                   │
│ ✅ Flush important buffers                             │
│                                                        │
│ ❌ Do NOT throw (noexcept → abort)                     │
│ ❌ Do NOT return (→ abort)                             │
│ ❌ Do NOT allocate heap memory (may fail)              │
│ ❌ Do NOT call complex functions (may throw)           │
