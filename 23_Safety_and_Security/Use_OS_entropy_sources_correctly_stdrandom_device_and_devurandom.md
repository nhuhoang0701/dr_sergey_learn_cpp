...
int main() {
    ...
    //
    // 3. SINGLE VALUE: mt19937 state is 624 × 32 bits = 19,968 bits
...
void bad_seeding() {
    ...
    // mt19937 has 624 × 32 = 19,968 bits of state
...
- **Performance:** `std::random_device` is 10-100× slower than mt19937. Use it only for seeding, not for high-volume generation.
