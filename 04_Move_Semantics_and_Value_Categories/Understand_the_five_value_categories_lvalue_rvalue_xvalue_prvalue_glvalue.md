...
Every C++ expression has exactly one of three primary value categories:
...
It represents an object whose resources are about to expire — it's safe to steal from.
