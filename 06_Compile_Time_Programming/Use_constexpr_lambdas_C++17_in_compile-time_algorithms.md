...
C++17 made lambdas **implicitly constexpr** whenever their body satisfies `constexpr` function requirements. This unlocked using lambdas as building blocks in compile-time algorithms.
...
Lambdas serve as **customization points** in compile-time algorithms — comparators, transformers, predicates:
