...
A **private module fragment** (`module :private;`) allows hiding implementation in the same file as the interface:
...
**Key benefit:** Changing the implementation in `module :private;` does NOT require recompilation of importers — only the module itself is recompiled. This is analogous to the pimpl idiom but built into the language.
