...
C++20 **modules** are a new compilation model that replaces the textual inclusion (`#include`) with a structured import system. Modules are compiled once into a **Binary Module Interface (BMI)** and imported by name.
